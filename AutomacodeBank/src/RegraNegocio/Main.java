...
public class Main {
	...
	static GerenciaClientes gerClientes;
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Leandro Amorim Viersberg", 39, "leandroviersberg@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Ciclano Beltrano", 34, "ciclano@gmail.com", conta02.getId(), true);
		Cliente cliente03 = new Cliente(3, "Fulano Ciclano", 38, "beltrano@gmail.com", conta02.getId(), true);
